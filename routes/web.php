...
Route::prefix('products')->group(function(){
 ...
 Route::get('/get-price','Backend\DefaultController@getPrice')->name('check-product-price');
 ...
 Route::prefix('analysis')->group(function(){
    ...
    Route::get('/profit/view','Backend\AnalysisController@profitReport')->name('analysis.view');
    Route::get('/daily/profit/view','Backend\AnalysisController@dailyProfitReport')->name('analysis.daily.view');
    Route::get('/daily/profit/pdf','Backend\AnalysisController@dailyProfitReportPdf')->name('analysis.daily.view.pdf');
