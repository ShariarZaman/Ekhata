            ...
            <div class="card">
              <div class="card-header">
                <h3>Product List 
                 ...
                 <a class="btn btn-success float-right btn small " href="{{route('products.add')}}"><i class=" fa fa-plus-circle "> </i> Add Product</a>
              ...
              <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$product->name}}</td>
                    <td><img src="{{(!empty($product->image))?url('public/upload/product_images/'.$product->image):url('public/upload/no_image.png')}}" width="140px" height="110px"></td>
