  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Credit Customers</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Credit Customer List 
                 ...
                 <a class="btn btn-success float-right btn small " href="{{route('customers.credit.pdf')}}" target="_blank"><i class=" fa fa-download "> </i> Download Pdf</a>
