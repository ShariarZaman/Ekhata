...
<link rel="stylesheet" href="{{asset('public/backend')}}/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('home')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Ekhata Menu</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar">
      <!-- Sidebar user panel picture user profile (optional) -->
...
@if(session()->has('error'))
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Shariar Zaman</a></strong>
    
    <div class="float-right d-none d-sm-inline-block">
      <b>Design & Develop By Shariar Zaman </b> 
    </div>
  </footer>
