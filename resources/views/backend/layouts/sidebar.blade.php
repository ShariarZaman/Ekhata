...
<!---- unit-->
  ...
  <li class="nav-item has-treeview {{($prefix=='/stock')?'menu-open':' '}} ">
        ...
        <li class="nav-item ">
          ...
          <li class="nav-item has-treeview {{($prefix=='/analysis')?'menu-open':' '}} ">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview ">
              <li class="nav-item ">
              <a href="{{route('analysis.view')}}" class="nav-link  {{($route=='analysis.view')?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Profit Report List</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview ">
            <li class="nav-item ">
            <a href="{{route('analysis.daily.view')}}" class="nav-link  {{($route=='analysis.daily.view')?'active':''}}">
                  <i class="far fa-circle nav-icon"></i>
