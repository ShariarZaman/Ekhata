          ...
          <section class="col-md-12 ">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <!--  <a class="btn btn-success float-right btn small " href=""><i class=" fa fa-plus-circle "> </i> Add Invoice</a> -->
              ...
              <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if($invoice->status=='0')
                      <a title="Approved"  class="btn btn-sm btn-success" href="{{route('invoice.approve',$invoice->id)}}"><i class="fa fa-check-circle"></i></a>
