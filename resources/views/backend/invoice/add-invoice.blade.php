            ...
            <div class="card">
              <div class="card-header">
                <h3>Add Invoice
                 ...
                 <a class="btn btn-success float-right btn small " href="{{route('invoice.view')}}"><i class=" fa fa-list "> </i> Invoice List</a>
                </h3>
              ...
              <div class="card-body">
               <div class="form-row"> 
                ...
                <input type="text" name="unit_price_buy" id="unit_price_buy" class="form-control form-control-sm" readonly style="background-color: #D8FDBA" >
                </div>
         ...
         <table class="table-sm table-bordered" width="100%" >
            ...
            <tbody>
              <tr>
                ...
                <td><input type="text" name="discount_amount" id="discount_amount" class="form-control form-control-sm text-right" placeholder="Enter Discount Amount"></td>
              </tr>
            <tr>
...
<script id="document-template" type="text/x-handlebars-template">
  ...
  <td>
    <input class="form-control from-control-sm text-right selling_price" name="selling_price[]" value="0" readonly>
  </td>
