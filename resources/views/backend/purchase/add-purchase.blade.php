            ...
            <div class="card">
              <div class="card-header">
                <h3>Add Purchase
                 ...
                 <a class="btn btn-success float-right btn small " href="{{route('purchase.view')}}"><i class=" fa fa-list "> </i>Purchase List</a>
                </h3>
...
<script id="document-template" type="text/x-handlebars-template">
  ...
  <td>
    <input class="form-control from-control-sm text-right buying_price" name="buying_price[]" value="0" readonly>
  </td>
